...
public class UserController {
    ...
    public String postUpdateUser(Model model, @ModelAttribute("newUser") User anh) {
        User currentUser = this.userService.getUserById(anh.getId());
        if (currentUser != null) {
            currentUser.setAddress(anh.getAddress());
