        ...
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <body>
                <div class="container mt-5">
                    ...
                    <form:form method="POST" action="/admin/sales-invoices/edit/${salesInvoice.salesInvoiceId}"
                        modelAttribute="salesInvoice">
                        <div class="mb-3">
                            ...
                            <form:select path="customer" class="form-select">
                                ...
                                <c:forEach items="${customers}" var="customer">
                                    <form:option value="${customer.customerId}"
                                        selected="${salesInvoice.customer.customerId == customer.customerId}">
                            ...
                            <form:select path="employee" class="form-select">
                                ...
                                <c:forEach items="${employees}" var="employee">
                                    <form:option value="${employee.employeeId}"
                                        selected="${salesInvoice.employee.employeeId == employee.employeeId}">
                            ...
                            <form:select path="stall" class="form-select">
                                ...
                                <c:forEach items="${stalls}" var="stall">
                                    <form:option value="${stall.stallId}"
                                        selected="${salesInvoice.stall.stallId == stall.stallId}">
