<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <head>
                <meta charset="UTF-8">
                <title>Edit Buyback Invoice Detail</title>
            ...
            <body>
                <div class="container mt-5">
                    <h1>Edit Buyback Invoice Detail</h1>
                    <form:form method="POST"
                        action="/admin/buyback-invoice-details/edit/${buybackInvoiceDetail.id.buybackInvoiceId}/${buybackInvoiceDetail.id.productId}"
                            ...
                            <form:select path="buybackInvoice" class="form-select">
                                ...
                                <c:forEach items="${buybackInvoices}" var="buybackInvoice">
                                    <form:option value="${buybackInvoice.buybackInvoiceId}"
                                        selected="${buybackInvoiceDetail.buybackInvoice.buybackInvoiceId == buybackInvoice.buybackInvoiceId}">
                                        ${buybackInvoice.buybackInvoiceId}</form:option>
                                </c:forEach>
                            </form:select>
                        </div>
                        <div class="mb-3">
                            ...
                            <form:select path="product" class="form-select">
                                ...
                                <c:forEach items="${products}" var="product">
                                    <form:option value="${product.productId}"
                                        selected="${buybackInvoiceDetail.product.productId == product.productId}">
