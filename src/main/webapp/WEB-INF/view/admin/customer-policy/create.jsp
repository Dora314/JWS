<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <head>
            <meta charset="UTF-8">
            <title>Create Customer Policy</title>
        ...
        <body>
            <div class="container mt-5">
                <h1>Create Customer Policy</h1>
                <form:form method="POST" action="/admin/customer-policies/create" modelAttribute="customerPolicy">
                    <div class="mb-3">
