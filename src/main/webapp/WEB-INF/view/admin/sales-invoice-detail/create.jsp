<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <head>
                <meta charset="UTF-8">
                <title>Create Sales Invoice Detail</title>
            ...
            <body>
                <div class="container mt-5">
                    <h1>Create Sales Invoice Detail</h1>
                    <form:form method="POST" action="/admin/sales-invoice-details/create"
                        ...
                        <div class="mb-3">
                            ...
                            <form:select path="salesInvoice" class="form-select">
                                ...
                                <c:forEach items="${salesInvoices}" var="salesInvoice">
                                    <form:option value="${salesInvoice.salesInvoiceId}">${salesInvoice.salesInvoiceId}
                                    </form:option>
                                </c:forEach>
                            </form:select>
                        </div>
