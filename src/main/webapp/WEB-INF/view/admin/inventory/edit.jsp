            ...
            <body>
                <div class="container mt-5">
                    ...
                    <form:form method="POST"
                        action="/admin/inventories/edit/${inventory.stall.stallId}/${inventory.product.productId}"
                            ...
                            <form:select path="stall" class="form-control">
                                ...
                                <c:forEach items="${stalls}" var="stall">
                                    <form:option value="${stall.stallId}"
                                        selected="${inventory.stall.stallId == stall.stallId}">
                            ...
                            <form:select path="product" class="form-control">
                                ...
                                <c:forEach items="${products}" var="product">
                                    <form:option value="${product.productId}"
                                        selected="${inventory.product.productId == product.productId}">
